        ...
        <div class="logo">
          ...
          <div class="slider_box team-box" v-if="navLayerShow == 'teamShow'">
            <div class="section scroll">
              <a href='javascript:void(0)' class="list" @click.stop="tabListFn(index)" v-for="(item,index) of list"
                :key="index"><i class="icon icon-yes" v-if="item.is_check"></i>{{item.name}}</a>
            </div>
            <div class="section">
            ...
            <fixed-slot>
              ...
              <template v-slot:none>
                <ul name="none" class="child-nav-list">
                  <li class="li">
                    <router-link @click.native="$cnzzFn('查询', '点击', '商标查询')" to="/search">商标查询</router-link>
                  </li>
                  <li class="li">
                    <router-link @click.native="$cnzzFn('查询', '点击', '公告查询')" to="/search/notice">公告查询</router-link>
                  </li>
                  <li class="li">
                    <router-link @click.native="$cnzzFn('查询', '点击', '续展/宽展查询')" to="/search/keep">续展/宽展查询</router-link>
                  </li>
                  <li class="li">
                    <router-link @click.native="$cnzzFn('查询', '点击', '法律文书查询')" to="/search/document">法律文书查询
                    </router-link>
                  </li>
                  <li class="li">
                    <router-link @click.native="$cnzzFn('查询', '点击', '分类表查询')" to="/search/kind">分类表查询</router-link>
                  </li>
      ...
      <div class="holder-box">
              ...
              <ul class="ul">
                <li class="li" v-for="(item, index) in downList" :key="index">
                  ...
                  <div class="edit-box">
                    ...
                    <span btn @click.stop="downDelFn(item.download_id, index)"
                      v-show="item.status == 3 || item.status == 4" class="btn">删除</span>
        ...
        <div class="person" btn>
          <span @click.stop="personSliderFn"><span class="img_box photo"
              v-if="is_default_headimg == 1 && user.title">{{user.title.substring(0,1)}}</span><span
              class="img_box photo" :class="{white: is_default_headimg != 1}" v-if="is_default_headimg != 1"><img
                class="img" :src="headerImg" alt=""></span></span>
