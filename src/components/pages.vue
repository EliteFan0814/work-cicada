...
.module_page{
  ...
  .to_number{
    ...
    height:$inpsmall; line-height: $inpsmall; width: 46px;  margin-right: 6px; 
  ...
  .page_ok{
    @extend .radius;
    text-align: center; box-sizing: border-box;
    width: 50px; border:1px solid $red2; margin-right: 0;
    background-color: $red2; color:$white;
    &:hover{
      background-color: $red2hover; color:$red2; border-color:$red2; 
    }
  }
}
